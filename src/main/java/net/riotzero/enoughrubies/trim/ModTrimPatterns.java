...
public class ModTrimPatterns {
    public static final RegistryKey<ArmorTrimPattern> HEARTSTONE = RegistryKey.of(RegistryKeys.TRIM_PATTERN,
            Identifier.of(EnoughRubies.MOD_ID, "heartstone"));

    public static void bootstrap(Registerable<ArmorTrimPattern> context) {
        register(context, ModItems.HEARTSTONE_SMITHING_TEMPLATE, HEARTSTONE);
    }
